...
class NewsRepository extends ServiceEntityRepository
{
    ...
    /**
     * @return News[] Returns an array of published news
     */
    ...
    /**
     * @return News[] Returns an array of recent published news
     */
    public function findRecentPublishedNews(int $limit = 3): array
    {
        return $this->createQueryBuilder('n')
            ->andWhere('n.isPublished = :val')
            ->setParameter('val', true)
